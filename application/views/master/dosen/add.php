    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="form-group">
                    <label for="nama_dosen">Nama Penanggung Jawab</label>
                    <input type="text" class="form-control" name="nama_dosen" placeholder="Nama Penanggung Jawab">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="email">Email Penanggung Jawab</label>
                    <input type="text" class="form-control" name="email" placeholder="Email Penanggung Jawab">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="matkul">Tipe Soal</label>
