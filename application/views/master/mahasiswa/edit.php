            ...
            <div class="col-sm-4 col-sm-offset-4">
                <?=form_open('mahasiswa/save', array('id'=>'mahasiswa'), array('method'=>'edit', 'id_mahasiswa'=>$mahasiswa->id_mahasiswa))?>
                    <div class="form-group">
                        ...
                        <input value="<?=$mahasiswa->nim?>" autofocus="autofocus" onfocus="this.select()" placeholder="NIK" type="text" name="nim" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <select id="Tujuan" name="jurusan" class="form-control select2">
