        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    ...
                    Jika kolom Tipe Soal kosong, berikut ini kemungkinan penyebabnya :
                    <br><br>
                    <ol class="pl-4">
                        <li>Anda belum menambahkan master data Tipe Soal (Master Tipe Soal kosong/belum ada data sama sekali).</li>
                        <li>Tipe Soal sudah ditambahkan, jadi anda tidak perlu tambah lagi. Anda hanya perlu mengedit data Tujuan - Tipe Soal nya saja.</li>
                    </ol>
                </div>
            </div>
            <div class="col-sm-4">
