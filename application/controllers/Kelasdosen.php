...
class KelasDosen extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Kelas - Penanggung Jawab',
			'subjudul'=> 'Data Kelas - Penanggung Jawab'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Kelas -  Penanggung Jawab',
			'subjudul'	=> 'Tambah Data Kelas - Penanggung Jawab',
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit Kelas - Penanggung Jawab',
			'subjudul'		=> 'Edit Data Kelas - Penanggung Jawab',
