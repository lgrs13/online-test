...
class JurusanMatkul extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Tujuan - Tipe Soal',
			'subjudul'=> 'Data Tujuan - Tipe Soal'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Tujuan - Tipe Soal',
			'subjudul'	=> 'Tambah Data Tujuan - Tipe Soal',
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit Tujuan - Tipe Soal',
			'subjudul'		=> 'Edit Data Tujuan - Tipe Soal',
